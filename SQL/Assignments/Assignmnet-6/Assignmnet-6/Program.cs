...
namespace Assignmnet_6
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"{i.EmployeeID}--> {i.FirstName} {i.LastName}  is joined on  {i.DOJ.ToShortDateString()}.");
            }
            Console.WriteLine();
            ...
            {
                Console.WriteLine($"{i.EmployeeID}-->  {i.FirstName} {i.LastName}  is born on  {i.DOJ.ToShortDateString()}.");
            }
            Console.WriteLine();
            ...
            Console.WriteLine($" total number of empolyess are  {empList.Count}");
            Console.WriteLine();
            ...
            if (young != null)
            {
                Console.WriteLine($"The youngest employees are  {young.FirstName} {young.LastName}");
            }
            Console.ReadLine();
        }
    }
